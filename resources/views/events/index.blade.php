...
<section class="text-gray-600 body-font">
  @if (session()->has('msg'))
    <div class="text-white bg-blue-500 font-bold py-2  rounded ">
        {{ session()->get('msg') }}
    </div>
  @endif
  <div class="container px-5 py-24 mx-auto">
    ...
    <div class="py-8 px-4 lg:w-1/3 {{ $event->premium ? 'border border-yellow-200 bg-amber-400' : 'border border-gray-100 bg-gray-100' }}">
